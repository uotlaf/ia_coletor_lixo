...
#define TEXT_HELP_ADD_FPS           "Aumentar limite de FPS"
#define TEXT_HELP_ADD_FPS_BUT       "<+>"
#define TEXT_HELP_SUB_FPS           "Diminuir limite de FPS"
#define TEXT_HELP_SUB_FPS_BUT       "<->"
